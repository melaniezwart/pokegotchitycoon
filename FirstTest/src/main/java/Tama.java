...
public class Tama{
	...
	//@ManagedProperty(value = "hunger")
	double hunger = 22;
	
	//@ManagedProperty(value = "happy")
	double happy = 50;
	
	//@ManagedProperty(value = "hygiene")
	double hygiene = 50;
	
	//@ManagedProperty(value = "sleep")
	double sleep = 90;
	...
	protected void randomEventListener(){
		...
		if(rebelNumber > 110) Game.rebelTimer = new Ticks("rebel");
